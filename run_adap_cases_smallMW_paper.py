        ...
        for adap in adaptivity[1:]:
            ...
            for line in template_lines:
                if "learning_rate: -1" in line and setlr:
                    ...
                    config_content.append(line.replace("  max_epochs: 120","  max_epochs: 150"))
            ...
            for line in template_lines:
                if "job_MW" in line:
                    ...
                    slurm_script_content.append(line.replace("16", "4"))
            ...
            os.chdir("/lustre/orion/lrn037/scratch/zhangp/matey_updated")
