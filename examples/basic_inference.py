...
from ruamel.yaml import YAML
from ruamel.yaml.comments import CommentedMap as ruamelDict
from matey.inference import Inferencer
...
if __name__ == '__main__':
    ...
    check_sp(inferencer.sequence_parallel_groups, global_rank)
    with profile_function(enabled=inferencer.profiling, logdir="./log_profiler_section_8worker_pinmem_prefetch_factor2") as prof:
        inferencer.infer()
        prof.step()
