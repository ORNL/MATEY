...
for icase, (caselabel, cutoff) in enumerate(zip(caselabels, cutoffs)):
    ...
    if iplot==0:
        ...
        axs[0,0].plot(range_f1,[0,0],"k--")
        axs[0,0].plot([0,0], range_f2,"k--")
        axs[0,0].plot([-2,2], [-2,2],"k--")
    ...
    axs[irow,icol].plot(range_f1,[0,0],"k--")
    axs[irow,icol].plot([0,0], range_f2,"k--")
    axs[irow,icol].plot([-2,2], [-2,2],"k--")
    if irow==1:
...
plt.savefig("/lustre/orion/lrn037/scratch/zhangp/fy25/GB/matey/GB/jpdf_omg_epsi_quad.png")
plt.savefig("/lustre/orion/lrn037/scratch/zhangp/fy25/GB/matey/GB/jpdf_omg_epsi_quad.pdf")
###############################################################################################
###############################################################################################
